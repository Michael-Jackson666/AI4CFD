...
def criterion_0(model_0, alpha_b, model_b, w, x):
    ...
    # print(Int_F_F)
    # print(Int_DeltaPhi_DeltaPhi)
    # print(Int_F_DeltaPhi)
...
def post_process(model_0, alpha_b, model_b, w, x):
    ...
    # error1 = error1_estimate(w, alpha_F, F, C, phi, grad_F, grad_phi, projection=False) / torch.sqrt(Int2TNN_amend_1d(w, w, alpha_F, F, alpha_F, F, grad_F, grad_F))
