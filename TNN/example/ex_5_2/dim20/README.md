# TNN 20D Non-homogeneous Boundary Value Problem

## Problem Description

Same as the 5D case but in **20 dimensions**.
...
**Source**: $F(x) = \sum_{i=1}^{20} \sin\left(\frac{\pi x_i}{2}\right)$
...
This demonstrates the two-TNN approach scales effectively to very high dimensions (20D).
